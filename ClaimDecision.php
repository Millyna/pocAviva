...
<div class="row">
    <div class="small-12 small-centered columns" id="journey1">
        <img id="journeyImg" src="components/images/decision.png">
    </div>
</div>

<div class="row">
    <div id="claimDecisionTitle" class="small-12 columns">
        <h4>Our Decision</h4>
    </div>
</div>

<div class="small-8 small-centered columns" id="claimDecision">
    <br>
    <br><br>
    <br><br>
    <br><br>
